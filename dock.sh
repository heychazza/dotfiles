...
declare -a apps=(
    ...
    'SPACER'
    '/Users/charlie/Applications/PhpStorm.app'
    '/Users/charlie/Applications/IntelliJ IDEA Ultimate.app'
    '/Applications/TablePlus.app'
    '/Applications/OrbStack.app'
    '/Applications/Herd.app'
    'SPACER'
    '/System/Applications/Utilities/Terminal.app'
    '/Applications/Tinkerwell.app'
...
for folder in "${folders[@]}"; do
    add_folder_to_dock "$folder" -a 2 -d 0 -v 1 # Adjust these flags as needed
done
